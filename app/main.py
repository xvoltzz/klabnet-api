...
from .routers import apps, health, identity, prefs, presence, sections
...
for router in (health.router, identity.router, prefs.router, presence.router, apps.router, sections.router):
